...
print(ql.q_table)
ql.set_model_value("new_cluster", 0, 3, "new_cluster")
print(ql.model)

ql.reset_q_table()
print(ql.q_table)
ql.reset_model_table()
print(ql.model)
...
print("Q_Table_Keys: ", ql.q_table.keys())
print("Q_Table_Values: ", ql.q_table.values())
print("Model_Keys: ", ql.model.keys())
print("Model_Values: ", ql.model.values())

print("Action List: ", ql.actions)

s = [1, 2, 3]
s_normalised = ql.normaliseFeatures(s)
print(s)
print(s_normalised)

feature_selected = ql.selectRandomFeatures(1)
print(feature_selected)

reward = ql.computeReward(0, len(s_normalised), s_normalised)
print("New Cluster Reward: ", reward)

reward = ql.computeReward(1, len(s_normalised), s_normalised)
