...
def main():
    ...
    p1 = Process(target=_Experiment_04.main, args=(main_path, 0, "", False, chooseAutoencoder))
    p1.start()

    p2 = Process(target=_Experiment_04.main, args=(main_path, 0, "", True, chooseAutoencoder))
    p2.start()
