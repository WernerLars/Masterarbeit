...
def main():
    ...
    p2.start()
    p3 = Process(target=Experiment_03.main, args=(main_path, 0, pc))
    p3.start()
    p4 = Process(target=Experiment_04.main, args=(main_path, 0, pc))
    p4.start()
    p5 = Process(target=Experiment_05.main, args=(main_path, 0, pc))
    p5.start()
